...
flowchart TD
    ...
    A --> C[DETENER]
    A --> D[OPCIONES AVANZADAS]

    %% ACCIONES DE ESCANEAR / DETENER
    B --> B1[Enviar URL /INICIAR]
    C --> C1[Enviar URL /PARAR_TODO]

    B1 --> B2[Mostrar "Escaneando..."]
    C1 --> C2[Mostrar "Proceso detenido"]
    ...
    %% RETORNOS
    E --> E1[Retornar "LED_ON"]
    F --> F1[Retornar "LED_OFF"]
    G --> G1[Retornar "MOTOR_ON"]
    H --> H1[Retornar "MOTOR_OFF"]
